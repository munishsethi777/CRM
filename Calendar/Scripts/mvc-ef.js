...
function ChangePasswordByAdmin(id) {
    // clear dialog window
    $('#dialog-add').html('');
    // Dialogs window for add
    $("#dialog-add").dialog({
        ...
        draggable: true,
        open: function (event, ui) {
            $.post("/Account/ChangeUserPasswordByAdmin/" + id,
                            {
                            },
                            function (data) {
                                $('#dialog-add').html(data.view);
...
function ForgetPassword() {
    // clear dialog window
    $('#dialog-add').html('');
    $('#dialog-add').html('Loading..<img src="../content/img/spinner_squares_circle.gif">');
    // Dialogs window for add
    $("#dialog-add").dialog({
